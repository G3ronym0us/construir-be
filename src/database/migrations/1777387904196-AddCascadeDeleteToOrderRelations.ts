...
export class AddCascadeDeleteToOrderRelations1777387904196
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT "FK_90d86777933726d503af6097991"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_90d86777933726d503af6097991" FOREIGN KEY ("payment_info_id") REFERENCES "payment_info"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_90d86777933726d503af6097991" FOREIGN KEY ("payment_info_id") REFERENCES "payment_info"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
